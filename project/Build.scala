  ...
  object autoImport {
    ...
    object ui {
      ...
      lazy val benchAll = command(
        "cleanAll",
        "compileAll",
        "bench/jmh:run RscParse RscIndex RscOutline RscSemanticdb RscScalasig ScalacCompile YoutlineCompile"
      )
      ...
      lazy val benchYoutline = "bench/jmh:run YoutlineCompile"
